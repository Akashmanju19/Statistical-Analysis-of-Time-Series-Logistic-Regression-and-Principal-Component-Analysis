df = read.csv("C:\\Users\\akash\\Desktop\\CLass Notes\\Stastics\\TABA\\CarRegistrations.csv", header = TRUE)
...
Values=read.csv('C:\\Users\\akash\\Desktop\\CLass Notes\\Stastics\\TABA\\CarRegistrations.csv')
Values
